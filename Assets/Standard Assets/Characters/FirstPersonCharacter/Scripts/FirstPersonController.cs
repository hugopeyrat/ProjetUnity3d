...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            deb_originalPosition = transform.position;
        ...
        private void Update()
        {
            ...
            //DEBUG reset
            if (Input.GetKeyDown(KeyCode.Backspace) && !is_freeze)
            {
                transform.position = deb_originalPosition;
            ...
            /*      if (Input.GetKeyDown(KeyCode.A) && is_freeze)
                  {
                      UnFreeze();
                  }
            */
        ...
        {
            is_paused = arg;
            GameManager.s_Singleton.PauseTime(arg);
            Cursor.visible = arg;
        ...
        private void GetInput(out float speed)
        {
            ...
            speed = m_IsWalking ? m_Spd : m_RunSpeed;
